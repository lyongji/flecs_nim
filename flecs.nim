...
when defined(useFuthark):
  importc:
    outputPath "src/flecs_nim_raw.nim"  # 生成的 Nim 绑定文件
    path "./flecs/distr/"  # 当前目录
    # TODO: 下次重新生成时加入以下优化
    # retype ecs_iter_t.ptrs, ptr UncheckedArray[pointer]
    # retype ecs_iter_t.entities, ptr UncheckedArray[ecs_entity_t]
    "flecs.h"
else:
  # 包含已生成的绑定文件
  include "./src/flecs_nim_raw.nim"
